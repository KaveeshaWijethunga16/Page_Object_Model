...
public class TC01_RegisterUserTest {
    ...
    public void TC01() {
        ...
        registerPage.setFirstname_loc("Kaveesha");
        registerPage.setLastname_loc("Wijethunga");
        registerPage.setEmail_loc("wijethunga@gmail.com");
        registerPage.setPhone_loc("0716845331");
        registerPage.setUsername_loc("Kaveesha");
        registerPage.setPassword_loc("12345");
        registerPage.setConfirmPassword_loc("12345");
